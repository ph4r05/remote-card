...
public class DemoApplet3 extends Applet implements MultiSelectable
{
	...
	{
		new DemoApplet3(bArray, bOffset, bLength);
	}

	public DemoApplet3(byte[] buffer, short offset, byte length)
	{
	...
	public void process(APDU apdu)
	{
		...
		random.generateData(tmpBuffer, (short) 6, (short) (BUFFER_SIZE-6));
