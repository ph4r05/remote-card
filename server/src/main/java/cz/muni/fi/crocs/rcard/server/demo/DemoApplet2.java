...
public class DemoApplet2 extends Applet implements MultiSelectable
{
	...
	{
		new DemoApplet2(bArray, bOffset, bLength);
	}

	public DemoApplet2(byte[] buffer, short offset, byte length)
	{
	...
	public void process(APDU apdu)
	{
		...
		random.generateData(tmpBuffer, (short) 10, (short) (BUFFER_SIZE-10));
